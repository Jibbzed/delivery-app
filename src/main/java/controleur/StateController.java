...
public class StateController {
    ...
    public void afficherMap(String title, String xmlMapPath) throws IOException {
        ...
        //TODO check if it is already loaded in the pagePrincipale page.
//        Parent root = pagePrincipale.getFXMLoader().load();
        this.fenetrePrincipaleController = pagePrincipale.getController();

        this.fenetrePrincipaleController.initialize(this,pagePrincipale.getFXMLoader(), xmlMapPath, title, pagePrincipale.getRootNode());
        try {
    ...
    // TODO: no need to have fxmlloader here ?
    public void ajouterLivraison(FXMLLoader fxmlLoader) throws IOException {
        ...
        // TODO i don't remember why there is this line, test its usefullness
        this.fenetreSaisieLivraisonController = null;
    }

    public void disableMapView(){
        this.fenetrePrincipaleController.disableView();
    }

    public void enableMapView() {
        this.fenetrePrincipaleController.enableView();
    }

    public void disableLivraisonDisableableComponenets() {
        this.fenetrePrincipaleController.disableLivraisonDisableableComponenets();
    }

    public void enableLivraisonDisableableComponenets() {
        this.fenetrePrincipaleController.enableLivraisonDisableableComponenets();
    }
